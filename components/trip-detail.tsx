    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-white p-6 shadow rounded-lg flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
                ...
                {trip.startDate.toLocaleDateString("en-GB", { year: "numeric", month: "numeric", day: "numeric" })} -{" "}
                {trip.endDate.toLocaleDateString("en-GB", { year: "numeric", month: "numeric", day: "numeric" })}
                </span>
            ...
            <div className="mt-4 md:mt-0">
                ...
                <Button> 
                <Plus className="mr-2 h-5 w-5"/> Add Location</Button>
                </Link>
